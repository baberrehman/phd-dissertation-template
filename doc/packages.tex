...
\lstdefinelanguage{Scala}{
  keywords={function, const, extends, super, class, export, boolean, throw, implements, import, this, typeof, new, true, false, catch, return, null, catch, switch, var, if, in, while, do, else, case, break,
  trait, with, def, String, Null, Unit, match, Int, Real, Bool, of, Integer, Float},
  identifierstyle=\color{black},
  comment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
...
\definecolor{codeback}{rgb}{0.95,0.95,0.97}
...
\lstdefinestyle{mystyle}{
    ...
    language=Java,
    morekeywords={then},
    deletekeywords={void, boolean, do}
}
\lstset{style=mystyle,mathescape=true}
